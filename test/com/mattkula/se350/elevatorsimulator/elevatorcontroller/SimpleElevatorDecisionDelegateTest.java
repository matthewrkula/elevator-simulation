...
public class SimpleElevatorDecisionDelegateTest {
	...
	public static void setup(){
		delegate = new SimpleElevatorDecisionDelegate();
	...
	public void testInTheMiddle(){
		assertEquals(1, delegate.getBestElevator(ElevatorController.DOWN, 7, dtos));
	}
